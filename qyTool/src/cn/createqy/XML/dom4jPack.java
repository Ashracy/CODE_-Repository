...
public class dom4jPack {
    ...
    //构造器
    dom4jPack(File file) throws FileMiss, DocumentException {
    ...
    dom4jPack(String conten , String charaset) throws DocumentException, UnsupportedEncodingException {
            ByteArrayInputStream bas=new ByteArrayInputStream(conten.getBytes(charaset));
            InputStream istem=bas;
            SAXReader saxReader=new SAXReader();
            document =saxReader.read(istem);
            root=document.getRootElement();
